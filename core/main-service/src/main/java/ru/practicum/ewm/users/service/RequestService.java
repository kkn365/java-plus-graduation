...
public interface RequestService {
     ...
     * @throws ru.practicum.core.api.exception.NotFoundException если пользователь не найден
     */
     ...
     * @throws ru.practicum.core.api.exception.NotFoundException  если пользователь или событие не найдены
     * @throws ru.practicum.core.api.exception.ConflictException  если пользователь является инициатором события,
