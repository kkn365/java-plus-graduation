...
/**
 * Реализация сервиса, отвечающего за генерацию рекомендаций мероприятий для пользователей.
 * <p>
 * Класс предоставляет методы для получения персонализированных рекомендаций на основе ранее рассчитанных коэффициентов
 * схожести между мероприятиями.
 */
@Slf4j
@Service
